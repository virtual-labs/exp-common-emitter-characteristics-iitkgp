...
var bcr;
function ibChange() {
    bcr = document.getElementById("ib").value;
    document.getElementById("ampb").value = bcr;
    check();
}
...
var basec;
function txtchngg() {
    basec = document.getElementById("ampb").value;
    document.getElementById("ib").value = basec;
}
var coem;
function txtchngn() {
    coem = document.getElementById("voltce").value;
    document.getElementById("cevlt").value = coem;
