...
var emcr;
function vbeChange() {
    emcr = document.getElementById("ibe").value;
    document.getElementById("ampe").value = emcr;
    check();
}

var vbcv;
function vbcchange() {
    vbcv = document.getElementById("bcvlt").value;
    document.getElementById("voltbc").value = vbcv;
    check();
}
var emc;
function txtchngg() {
    emc = document.getElementById("ampe").value;
    document.getElementById("ibe").value = emc;
}
var baseco;
function txtchngn() {
    baseco = document.getElementById("voltbc").value;
    document.getElementById("bcvlt").value = baseco;
...
function tabled() {
    ...
    arr[0] = tabrowindex + 1;
    arr[1] = document.getElementById("voltbc").value;
    arr[2] = document.getElementById("ampc").value;

    table = document.getElementById("mytable");
    if (document.getElementById("voltbc").value == "") {
...
//    document.getElementById("clr").style.display = "none";
    ...
    document.getElementById("bcvlt").value = "";
    document.getElementById("ibe").value = "";
