...
var vcev;
function vcechange() {
    vcev = document.getElementById("cevlt").value;
    document.getElementById("voltce").value = vcev;
    check();
}
var baseem;
function txtchngg() {
...
var colcem;
function txtchngn() {
    colcem = document.getElementById("voltce").value;
    document.getElementById("cevlt").value = colcem;
...
function clearfn() {
    ...
    document.getElementById("cevlt").value = "";
