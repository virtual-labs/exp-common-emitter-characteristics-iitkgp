...
var vbev;
function vbeChange() {
    vbev = document.getElementById("bevlt").value;
    document.getElementById("voltbe").value = vbev;
    check();
}
...
var baseem;
function txtchngg() {
    baseem = document.getElementById("voltbe").value;
    document.getElementById("bevlt").value = baseem;
}
var baseco;
function txtchngn() {
...
function tabled() {
    ...
    else if (vlt1 == document.getElementById("voltbe").value) {
        // Alert.render("Change the Base-Emitter Voltage");
        document.getElementById("voltbe").style.borderColor = "red";
        document.getElementById("demo").innerHTML = "Change the Base-Emitter Voltage";
    }
...
//    document.getElementById("clr").style.display = "none";
    ...
    document.getElementById("bevlt").value = "";
